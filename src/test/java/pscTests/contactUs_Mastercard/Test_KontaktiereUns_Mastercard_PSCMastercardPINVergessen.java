...
public class Test_KontaktiereUns_Mastercard_PSCMastercardPINVergessen extends BaseClass{
    ...
    public void contactUs_Mastercard_PSCMastercardPINVergessen() {
...
//      Step 3: Select "Ich habe die PIN für meine paysafecard Mastercard vergessen" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickMastercard_PINMastercardVergessen();
        KontaktiereUns.clickNextStepContactUs();
