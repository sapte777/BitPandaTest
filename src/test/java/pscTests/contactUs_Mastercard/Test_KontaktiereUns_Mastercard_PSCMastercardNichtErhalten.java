...
public class Test_KontaktiereUns_Mastercard_PSCMastercardNichtErhalten extends BaseClass{
    ...
    public void contactUs_Mastercard_PSCMastercardNichtErhalten() {
...
//      Step 3: Select "Ich habe meine paysafecard Mastercard nicht erhalten" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickMastercard_PSCMastercardNichtErhalten();
        KontaktiereUns.clickNextStepContactUs();
...
//      Step 4: Upload  document file and insert email address on "Required information" topic
        ...
        KontaktiereUns.uploadMastercardDocFile(docFilePath1);
        KontaktiereUns.clickNextStepContactUs();
