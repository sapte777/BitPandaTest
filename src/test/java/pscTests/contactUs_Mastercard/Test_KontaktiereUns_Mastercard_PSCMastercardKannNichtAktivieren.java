...
public class Test_KontaktiereUns_Mastercard_PSCMastercardKannNichtAktivieren extends BaseClass{
    ...
    private String pinDigits=CRTestUtils.getRandomNumberString(4);




    @Test(description = "Contact us login fill form" , retryAnalyzer = RetryAnalyzer.class)
    public void contactUs_Mastercard_PSCMastercardKannNichtAktivieren() {
...
//      Step 3: Select "Ich kann meine paysafecard Mastercard nicht aktivieren" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickMastercard_PSCMastercardNichtAktivieren();
        KontaktiereUns.clickNextStepContactUs();
...
//      Step 4: Insert email address on "Required information" topic
        ...
        KontaktiereUns.insert4digitsPINMastercard(pinDigits);
        KontaktiereUns.clickNextStepContactUs();
