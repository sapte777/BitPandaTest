...
public class Test_KontaktiereUns_Mastercard_PSCMastercardKundigen extends BaseClass{
    ...
    public void contactUs_Mastercard_PSCMastercardKundigen() {
...
//      Step 3: Select "Ich möchte meine paysafecard Mastercard kündigen" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickMastercard_PSCMastercardkundigen();
        KontaktiereUns.clickNextStepContactUs();
