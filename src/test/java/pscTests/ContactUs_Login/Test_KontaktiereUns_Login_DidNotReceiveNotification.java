...
public class Test_KontaktiereUns_Login_DidNotReceiveNotification extends BaseClass{
    ...
    public void contactUs_login_DidNotReceiveNotification() {
...
//      Step 3: Select "I didn't receive email notification" option from the dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickDidNotReceiveNotifFromContactUs();
        KontaktiereUns.clickNextStepContactUs();
