...
public class Test_KontaktiereUns_Login_ForgotLoginDetails extends BaseClass{
    ...
    public void contactUs_login_ForgotLoginDetails() {
...
//      Step 3: Select "I have forgotten my login details" option from the dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickForgotLoginDetailsFromContactUs();
        KontaktiereUns.clickColapseAnmeldendatenVorgessen();
        KontaktiereUns.clickNextStepContactUs();
