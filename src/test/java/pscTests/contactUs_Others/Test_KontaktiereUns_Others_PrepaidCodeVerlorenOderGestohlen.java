...
public class Test_KontaktiereUns_Others_PrepaidCodeVerlorenOderGestohlen extends BaseClass{
    ...
    public void contactUs_Mastercard_PrepaidCodeVerlorenOderGestohlen() {
...
//      Step 2: Select "Sonstiges" option from the dropdown menu on "How can we help you?" topic
...
//      Step 3: Select "paysafecard Prepaid Code ist verloren gegangen oder wurde gestohlen" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickOthers_PrepaidCodeIstVerlorenOderGestohlen();
        KontaktiereUns.clickNextStepContactUs();
