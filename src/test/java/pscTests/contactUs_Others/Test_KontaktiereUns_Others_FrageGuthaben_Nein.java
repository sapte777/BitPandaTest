...
public class Test_KontaktiereUns_Others_FrageGuthaben_Nein extends BaseClass{
    ...
    public void contactUs_Mastercard_FrageGuthaben_Nein() {
...
//      Step 5: Insert email address on "Required information" topic
        KontaktiereUns.insertSerieNumberOptional(serieNumber);
        KontaktiereUns.clickNextStepContactUs();
