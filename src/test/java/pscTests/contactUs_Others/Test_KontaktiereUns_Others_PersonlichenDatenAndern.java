...
public class Test_KontaktiereUns_Others_PersonlichenDatenAndern extends BaseClass{
    ...
    public void contactUs_Mastercard_PersonlichenDatenAndern() {
...
//      Step 3: Select "Ich möchte meine persönlichen Daten ändern" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickOthers_PersonalDataChange();
        KontaktiereUns.clickNextStepContactUs();
