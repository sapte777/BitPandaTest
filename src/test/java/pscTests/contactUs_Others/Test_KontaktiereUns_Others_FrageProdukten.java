...
public class Test_KontaktiereUns_Others_FrageProdukten extends BaseClass{
    ...
    public void contactUs_Mastercard_FrageProdukten() {
...
//      Step 3: Select "Ich habe eine allgemeine Frage zu den Produkten" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickOthers_FrageZuDenProdukten();
        KontaktiereUns.clickNextStepContactUs();
