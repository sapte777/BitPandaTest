...
public class Test_KontaktiereUns_Others_KontoKundigen extends BaseClass{
    ...
    public void contactUs_Mastercard_KontoKundigen() {
...
//      Step 3: Select "Ich möchte mein paysafecard Konto kündigen" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickOthers_PSCAccountCancelationn();
        KontaktiereUns.clickNextStepContactUs();
