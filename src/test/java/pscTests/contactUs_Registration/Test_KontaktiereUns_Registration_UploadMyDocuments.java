...
public class Test_KontaktiereUns_Registration_UploadMyDocuments extends BaseClass{
    ...
    public void contactUs_Registration_UploadMyDocuments() {
...
//      Step 3: Select "I have a question about uploading my documents" option from the dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickQuestionsUploadMyDocumentsFromContactUs();
