...
public class Test_KontaktiereUns_Registration_ConfirmEmailAddress extends BaseClass{
    ...
    public void contactUs_Registration_ConfirmEmailAddress() {
...
//      Step 3: Select "I want to confirm my email address" option from the dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickConfirmEmailAddressFromContactUs();
        KontaktiereUns.clickNextStepContactUs();
