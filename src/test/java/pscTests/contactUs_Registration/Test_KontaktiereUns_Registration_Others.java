...
public class Test_KontaktiereUns_Registration_Others extends BaseClass{
    ...
    public void contactUs_Registration_Others() {
...
//      Step 3: Select "Others" option from the dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickRegistrationOthersFromContactUs();
        KontaktiereUns.clickNextStepContactUs();
