...
public class Test_KontaktiereUns_Zahlungen_JuniorPIN_Case_Ja extends BaseClass{
...
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickPSCCodeUnter18JGekauft();
        KontaktiereUns.clickNextStepContactUs();
        bereitsPSCKontoText=KontaktiereUns.getBereitsPSCKontoText();
        Assert.assertEquals(bereitsPSCKontoText,bereitsPSCKontoTitle);

//      Step 4: Select "Nein" option from "Ich habe versehentlich einen paysafecard Prepaid Code für
...
//      Step 4: Upload four documents file on "Required information" topic
        ...
        KontaktiereUns.uploadIdentityCardOptionalFile(docFilePath);
