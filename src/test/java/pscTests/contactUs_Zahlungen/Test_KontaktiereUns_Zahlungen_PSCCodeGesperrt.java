...
public class Test_KontaktiereUns_Zahlungen_PSCCodeGesperrt extends BaseClass{
    ...
    public void contactUs_Zahlungen_PSCCodeGesperrt() {
...
//      Step 3: Select "paysafecard Prepaid Code wurde gesperrt" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickPSCCodeWurdeGesperrt();
        KontaktiereUns.clickNextStepContactUs();
...
//      Step 4: Upload document file on "Required information" topic
