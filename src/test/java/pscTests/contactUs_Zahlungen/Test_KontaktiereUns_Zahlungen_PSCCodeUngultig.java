...
public class Test_KontaktiereUns_Zahlungen_PSCCodeUngultig extends BaseClass{
    ...
    public void contactUs_Zahlungen_PSCCodeUngultig() {
...
//      Step 3: Select "paysafecard Prepaid Code ist ungültig" option from the
//      dropdown menu on "What is your enquiry about?" topic
        KontaktiereUns.clickPSCCodeIstUngultig();
        KontaktiereUns.clickNextStepContactUs();
