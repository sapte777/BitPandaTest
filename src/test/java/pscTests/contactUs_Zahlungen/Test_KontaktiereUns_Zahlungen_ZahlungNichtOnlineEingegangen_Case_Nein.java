...
public class Test_KontaktiereUns_Zahlungen_ZahlungNichtOnlineEingegangen_Case_Nein extends BaseClass{
    ...
    public void contactUs_Zahlungen_ZahlungNichtOnlineEingegangen_Nein() {
...
//      Step 4: Select "Nein" option from "Die Zahlung ist nicht beim Online-Shop eingegangen" topic
        KontaktiereUns.clickPSCCodeOnlineNichtAkzeptiert_Nein();
        KontaktiereUns.clickNextStepContactUs();
...
//      Step 4: Upload document file ans psc seriennnumber on "Required information" topic
        KontaktiereUns.insertSerieNumberZahlungen(serieNumber);
