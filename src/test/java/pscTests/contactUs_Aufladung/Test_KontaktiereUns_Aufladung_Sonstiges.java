...
public class Test_KontaktiereUns_Aufladung_Sonstiges extends BaseClass{
    ...
    public void contactUs_Aufladung_Sonstiges() {
...
//      Step 3: Select "Sonstiges" from "Worum geht es bei deiner Anfrage?" topic
        KontaktiereUns.clickAufladung_Sonstiges();
        KontaktiereUns.clickNextStepContactUs();
